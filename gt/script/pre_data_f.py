...
# 1. 경로 설정
LABEL_DIR = '/home/elicer/dev/detectron2/final_data/train/labels'  # 원본 라벨 폴더
IMAGE_DIR = '/home/elicer/dev/detectron2/final_data/train/images'  # 원본 이미지 폴더

# 중간 생성 파일 (전체 데이터 JSON)
FULL_JSON_PATH = '/home/elicer/dev/gt/data/label_data/train_coco_full.json' 
# 최종 생성 파일 (샘플링된 데이터 JSON) - 학습엔 이걸 쓰세요
SAMPLED_JSON_PATH = '/home/elicer/dev/gt/data/label_data/train_coco_stratified.json'
